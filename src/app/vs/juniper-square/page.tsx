...
import { ArrowRight, Check, X, Globe, DollarSign, Layers } from "lucide-react";

export const metadata: Metadata = {
  title: "Vistaley vs Juniper Square — Fund Management Comparison",
  description:
    "Compare Vistaley VentureLens and Juniper Square for fund management. See pricing, emerging market features, and which platform fits your fund size.",
  alternates: { canonical: "https://vistaley.com/vs/juniper-square" },
};
...
const features = [
  ...
  { feature: "LP / investor portal", vistaley: true, competitor: true },
  ...
  { feature: "Capital calls & distributions", vistaley: true, competitor: true },
  { feature: "Document management", vistaley: true, competitor: true },
  { feature: "CRM / investor relations", vistaley: false, competitor: true },
...
export default function VsJuniperSquarePage() {
  const jsonLd = {
    ...
    "@type": "WebPage",
    name: "Vistaley vs Juniper Square — Fund Management Comparison",
    description: "Compare Vistaley and Juniper Square for fund management.",
    url: "https://vistaley.com/vs/juniper-square",
  };
        ...
        <div className="relative mx-auto max-w-5xl px-6 pb-24 pt-24 sm:pt-32 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="mt-6 text-4xl font-bold tracking-tight text-white sm:text-5xl">
              Vistaley vs Juniper Square
            </h1>
            <p className="mt-4 text-lg text-white/40">
              Juniper Square is built for large US-based PE/VC firms. VentureLens is built for the next generation of funds in emerging markets — and starts free.
            </p>
          </div>
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2">
            <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/[0.04] p-6">
              ...
              <p className="mt-2 text-sm text-white/40">
                Transparent pricing from $0. Growth at $49/mo, Professional at $149/mo. No hidden fees.
              </p>
            </div>
            <div className="rounded-xl border border-white/[0.08] bg-white/[0.02] p-6">
              <div className="flex items-center gap-2">
                <DollarSign className="h-5 w-5 text-white/40" />
                <span className="font-semibold text-white/60">Juniper Square</span>
              </div>
              <div className="mt-4 flex items-baseline gap-1">
                <span className="text-4xl font-bold text-white">Custom</span>
              </div>
              <p className="mt-2 text-sm text-white/40">
                Enterprise pricing, typically $15K+/year. Requires sales engagement.
              </p>
            </div>
          </div>
              ...
              <table className="w-full text-left text-sm">
                <thead>
                  <tr className="border-b border-white/[0.06] bg-white/[0.02]">
                    ...
                    <th className="px-4 py-3 text-center text-xs font-semibold uppercase tracking-wider text-white/40">Juniper Square</th>
                  </tr>
                </thead>
                <tbody>
                  {features.map((row) => (
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2">
            <div className="rounded-xl border border-emerald-500/10 bg-emerald-500/[0.02] p-6">
              ...
              <ul className="mt-4 space-y-2">
                {[
                  ...
                  "You need to start free and scale later",
                  "You want free tools for portfolio companies",
                  "You need multi-currency as a core feature",
                ].map((item) => (
            ...
            <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-6">
              <h3 className="text-lg font-semibold text-white/60">Choose Juniper Square if</h3>
              <ul className="mt-4 space-y-2">
                {[
                  "You manage large US-based PE or VC funds",
                  "You need advanced CRM/investor relations",
                  "You have enterprise budget ($15K+/yr)",
          ...
          <div className="mt-16 rounded-xl border border-white/[0.08] bg-white/[0.02] p-8 text-center">
            <h2 className="text-2xl font-bold text-white">
              Professional fund management — free to start
            </h2>
            <p className="mt-2 text-sm text-white/40">
              No sales calls. No enterprise contracts. Start with VentureLens for free and upgrade when you&apos;re ready.
            </p>
